...
- `[SHOULD]` **TURN server support** — target: post-v1.0.0. Allow connections through symmetric NAT / corporate firewalls (e.g. phone on 5G). Requires a hosted or third-party TURN server.
